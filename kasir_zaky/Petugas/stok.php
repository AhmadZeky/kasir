                    ...
                    <div class="table-responsive">
                     ...
                     $sql = $koneksi->query("SELECT * FROM produk");
                            ...
                            <tr>
                                ...
                                <td><a type='button' href='?page=edit-stok&ProdukID=<?= $data['ProdukID']; ?>' class='btn btn-sm btn-warning'>Edit</a> <a type='button' href='?page=hapus-brg&ProdukID=<?= $data['ProdukID']; ?>' class='btn btn-sm btn-danger'>Delete</a></td>
                                <td>
