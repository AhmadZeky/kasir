<?php
    ...
    if (isset($_POST['tambah'])) {
        ...
        if ($stok) {
        $sql_penjual = $koneksi->query("INSERT INTO penjual (TanggalPenjual) VALUES ('$tanggal')");
        $id_transaksi_baru = $koneksi->insert_id;

        $sql_pelanggan = $koneksi->query("INSERT INTO pelanggan (PelangganID, NamaPelanggan, nomor_meja) VALUES ('$id_transaksi_baru', '$nama', '$nomeja')");
        ...
        foreach ($menu_jumlah as $i => $item) {
            ...
            $sql3 = $koneksi->query("INSERT INTO detailpenjualan (DetailID, ProdukID, JumlahProduk, Subtotal) VALUES ('$id_pelanggan_baru', '$produk_id', '$jumlah', '$harga')");
            if (!$sql3) {
                ...
                <div class="container mt-5">
                    ...
                    <form action="" method="POST">
                        <div class="col-2">
                            ...
                            <input type="date" value="<?php echo date('Y-m-d'); ?>" class="form-control" id="TanggalPenjual" name="TanggalPenjual" readonly required>
                        </div>
                        <div>
